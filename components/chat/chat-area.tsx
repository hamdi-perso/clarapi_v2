          ...
          <div className="flex items-start gap-2">
            <div className="flex-1 relative">
              <textarea
                ...
                disabled={isLoading}
                rows={1}
                className="w-full resize-none rounded-lg border border-input bg-background px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed min-h-[48px] max-h-[200px]"
              />
            </div>
            <button
              onClick={handleSend}
